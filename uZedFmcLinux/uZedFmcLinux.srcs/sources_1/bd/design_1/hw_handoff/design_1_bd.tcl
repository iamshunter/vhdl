...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set PulseOut [ create_bd_port -dir O PulseOut ]
  set TimerOut [ create_bd_port -dir O -type intr TimerOut ]

  # Create instance: IntToPulse_0, and set properties
  set block_name IntToPulse
  set block_cell_name IntToPulse_0
  if { [catch {set IntToPulse_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $IntToPulse_0 eq "" } {
  ...
  connect_bd_net -net IntToPulse_0_o_One [get_bd_ports TimerOut] [get_bd_pins IntToPulse_0/o_One]
  connect_bd_net -net IntToPulse_0_o_Two [get_bd_ports PulseOut] [get_bd_pins IntToPulse_0/o_Two]
  connect_bd_net -net fit_timer_0_Interrupt [get_bd_pins IntToPulse_0/i_Interrupt] [get_bd_pins fit_timer_0/Interrupt]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins IntToPulse_0/i_Clock] [get_bd_pins fit_timer_0/Clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
